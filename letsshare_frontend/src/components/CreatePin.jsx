...
const CreatePin = ({ user }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-roow flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
            ...
            {!imageAsset ? (
              <label>
                <div className="flex flex-col  items-center justify-center h-full cursor-pointer">
                  ...
                  <p className="mt-32 text-gray-400 text-align-center">
                    Use high quality JPEG, PNG, GIFs less than 20 MB
                  </p>
                </div>
                <input
                  type="file"
